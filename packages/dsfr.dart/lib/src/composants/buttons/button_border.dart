...
class DsfrButtonBorder extends WidgetStateProperty<Border> {
  DsfrButtonBorder({required final Border $default, required final Border disabled}) : _default = $default, _disabled = disabled;
    ...
    switch (variant) {
      ...
      case DsfrButtonVariant.secondary:
        return DsfrButtonBorder(
          $default: const Border.fromBorderSide(BorderSide(color: DsfrColors.blueFranceSun113)),
          disabled: const Border.fromBorderSide(BorderSide(color: DsfrColors.grey925)),
        );
      case DsfrButtonVariant.tertiary:
        return DsfrButtonBorder(
          $default: const Border.fromBorderSide(BorderSide(color: DsfrColors.grey900)),
          disabled: const Border.fromBorderSide(BorderSide(color: DsfrColors.grey925)),
        );
    }
  }
  ...
  @override
  Border resolve(final Set<WidgetState> states) => states.contains(WidgetState.disabled) ? _disabled : _default;
}
