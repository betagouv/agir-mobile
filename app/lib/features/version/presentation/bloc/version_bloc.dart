...
class VersionBloc extends Bloc<VersionEvent, VersionState> {
  VersionBloc({required final VersionRepository repository}) : super(const VersionState('')) {
    on<VersionFetched>((final event, final emit) => emit(VersionState(repository.current())));
  }
}
