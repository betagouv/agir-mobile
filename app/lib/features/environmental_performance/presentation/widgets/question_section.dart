  ...
  Widget build(final BuildContext context) => ListView(
        ...
        children: [
          const Padding(
            ...
            child: Text(
              EnvironmentalPerformanceLocalisation.uneQuestion,
            ...
            values: [
              DsfrAccordion(
                headerBuilder: (final isExpanded) => const _AccordionHeader(
                  text: EnvironmentalPerformanceLocalisation.quEstCeQuUn,
                ),
                body: _AccordionBody(
                  child: MarkdownBody(
                    data:
                        EnvironmentalPerformanceLocalisation.quEstCeQuUnContenu,
              ...
              DsfrAccordion(
                headerBuilder: (final isExpanded) => const _AccordionHeader(
                  text: EnvironmentalPerformanceLocalisation.commentEstCalcule,
                ),
                body: _AccordionBody(
                  child: MarkdownBody(
                    data: EnvironmentalPerformanceLocalisation
