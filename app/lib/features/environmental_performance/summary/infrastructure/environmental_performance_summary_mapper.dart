...
abstract final class EnvironmentalPerformanceSummaryMapperyMapper {
  ...
  static EnvironmentalPerformancePartial _fromPartialJson(
    ...
    return EnvironmentalPerformancePartial(
      performanceOnTransport: _mapLevelFromJson(
        partial['impact_transport'] as String?,
      ),
      performanceOnFood: _mapLevelFromJson(
        partial['impact_alimentation'] as String?,
      ),
      performanceOnHousing: _mapLevelFromJson(
        partial['impact_logement'] as String?,
      ),
  ...
  static EnvironmentalPerformanceFull _fromFullJson(
    ...
    return EnvironmentalPerformanceFull(
      footprintInKgOfCO2ePerYear: Footprint(
        (full['impact_kg_annee'] as num).toDouble(),
      ),
      top:
          (full['top_3'] as List<dynamic>)
              .map((final e) => e as Map<String, dynamic>)
  ...
  static EnvironmentalPerformanceDetailItem _detailItemFromJson(
    ...
    footprintInKgOfCO2ePerYear: Footprint(
      (json['impact_kg_annee'] as num).toDouble(),
    ),
    subItems:
