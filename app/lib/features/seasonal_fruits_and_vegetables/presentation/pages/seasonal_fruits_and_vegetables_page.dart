...
final class _Body extends StatelessWidget {
  ...
  Widget build(final BuildContext context) {
    ...
    return switch (state) {
      SeasonalFruitsAndVegetablesInitial() =>
            ...
            WidgetSpan(
              ...
              child: FnvDropdown(
                ...
                onChanged: (final value) =>
                    context.read<SeasonalFruitsAndVegetablesBloc>().add(
                          SeasonalFruitsAndVegetablesMonthSelected(value),
                        ),
              ),
            ),
          ],
